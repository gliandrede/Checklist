...
<section class="section-centralizar d-flex flex-column">
    <section class="section-check">
        ...
        <section class="footer-checks d-flex flex-column">
            ...
            <input id="txtPessoaTestou" type="text" name="">
...
<script type="text/javascript">
    ...
    //set initial state.
        $('#check3').change(function() {
            if($(this).is(":checked")) {
                ...
                $(".field-checkbox").find(".field").addClass("required")
            }else{
                $(".check--banco").hide("fade",100);
                $(".field-checkbox").find(".field").removeClass("required")
            }
        });
    ...
    function verifyForm() {
        $(".required").each(function(){
            if(!($(this).is(":checked")) || $("#txtPessoaTestou").val()==""){
                return false;
            }
        })
        return true;
    ...
    function sendForm(){
        if(verifyForm()){
            $.ajax({
              ...
              type: "POST",
              data: "banco="+$("#check3").is(":checked")+"&tipoApp="+$("#slcTipoAplicacao").val()+"&formaTeste="+$("#slcFormaTeste").val()+"&pessoaTestou="+$("#txtPessoaTestou").val(),
              dataType: "html"
